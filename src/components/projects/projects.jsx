...
export default function Projects() {
  // NOTE:  If you want to add more, duplicate from "{" to "}," and enter the new information needed. it will populate as needed.
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "Restaurant",
      para: "World-class restaurants will be available.",
    },
    {
      id: 3,
  ...
  return (
    <div className="h-full justify-center pt-20 md:pt-20 lg:px-20 px-4 pb-40 items-center align-center magicpattern">
      <h1 className="text-black font-bold text-center pt-20 pb-20 text-5xl">
